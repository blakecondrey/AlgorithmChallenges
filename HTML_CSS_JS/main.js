...
const stringToPrint= `The team ${team4["name"]} were founded in ${team4["Founded"]}. This team is from ${team4["City"]}`;
...
var packersPrint = `The team ${nameOfTeam} were founded in ${yearFoundation}`;
console.log(packersPrint);